...
[1]:https://vignette.wikia.nocookie.net/starwars/images/d/d8/Mara_insidercover.jpg/revision/latest?cb=20070701201021 "Mara Jade Skywalker"
...
In Cartesian coordinates, if **p** = (p~1~, p~2~,..., p~n~) and **q** = (q~1~, q~2~,..., q~n~) are two points in Euclidean *n*-space, then the disance (d) from **p** to **q** , or from **q** to **p** is given by the Pythagorean formula:
...
> $\left\|{\textbf{p}} \right\| = \sqrt{p_1^2 + p_2^2 + \dots + p_n^2} = \sqrt{\textbf{p} \cdot \textbf{p}}$
